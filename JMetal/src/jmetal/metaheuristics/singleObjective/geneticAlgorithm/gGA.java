...
//	}
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException
	{
		...
		{
			newIndividual = createNewSolution(problem_);
...
////				System.
//				System.out.println("Validação: "+evaluations +" Inicio:("+(tempoAgora-tempoInicio)+") - Anterior:("+(tempoAgora-tempoAnterior)+") Tempo:"+dataAtual);
