...
public abstract class Problem implements Serializable
{
	...
	/**
	 * Setup the problem in a single bound
	 * 
	 ...
	 */
	protected void setupProblem (int numberOfVariables, int numberOfObjectives, int numberOfConstraints, SolutionType solutionType)
	{
		...
		this.variableType_ = new Class[numberOfVariables_];
		this.length_ = new int[numberOfVariables_];
		this.length_[0] = numberOfVariables_;
	}

	/**
	 * Set the same limits for all problem variables
	 */
	protected void setAllVariableLimits(double lowerBound, double upperBound)
	{
		...
		{
			lowerLimit_[i] = lowerBound;
			upperLimit_[i] = upperBound;
		}
	}
}