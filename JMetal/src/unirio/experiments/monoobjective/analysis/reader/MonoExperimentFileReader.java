package unirio.experiments.monoobjective.analysis.reader;
...
import unirio.experiments.monoobjective.analysis.model.MonoExperimentCycle;
...
public class MonoExperimentFileReader
{
	...
	private void parseSolution (String solution, MonoExperimentCycle cycle, int solutionSize) throws MonoExperimentFileReaderException
	{
		...
		String[] tokens = new String[sSolution.length()];
		for (int i = 0; i < sSolution.length(); i++)
			tokens[i] = String.valueOf(sSolution.charAt(i));
