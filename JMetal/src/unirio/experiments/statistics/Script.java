...
public class Script
{
	...
	public void tableMin(List<ExperimentalData> columns, String type, String prefix)
	{
		String names = getExperimentalDataNames(columns, type);
		String result = "";
		int count = 0;
	...
	public void tableMax(List<ExperimentalData> columns, String type, String prefix)
	{
		String names = getExperimentalDataNames(columns, type);
		String result = "";
		int count = 0;
